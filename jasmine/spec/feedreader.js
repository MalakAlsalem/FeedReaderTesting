    ...
    */
    ...
    describe('The menu', function() {
        ...
        it('is hidden', function() {
            expect(menu1.hasClass('menu-hidden')).toBe(true);
        });
        ...
        it('changes visibility', function() {
            var menuClicked = $('.menu-icon-link');

            menuClicked.click();
            expect(menu1.hasClass('menu-hidden')).toBe(false);
    ...
    describe ('Initial Entries', function() {
        ...
        /* ensure that data is loaded before test*/
